...
import br.com.chatandroid.studentroom.helper.SlidingTabStrip
import com.example.chatKotlin.chat.helper.SlidingTabLayout.TabColorizer
...
class SlidingTabLayout @JvmOverloads constructor(
    ...
    private fun scrollToTab(tabIndex: Int, positionOffset: Int) {
        val tabStripChildCount: Int = mTabStrip.getChildCount()
